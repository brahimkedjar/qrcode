...
<#
.SYNOPSIS
    Synchronises tables from the â€œliveâ€ CMADONNEES database into the local customised copy.
...
.DESCRIPTION
    ...
    Requirements:
      â€¢ Microsoft Access Database Engine (ACE OLEDB) installed (32â€‘ or 64â€‘bit to match PowerShell).
      â€¢ Source database accessible (UNC share or mapped drive).
      â€¢ No-one should have the destination MDB open when the script runs.
#>
